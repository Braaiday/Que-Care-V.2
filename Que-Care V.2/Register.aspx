                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <div class="form-group">
                            ...
                            <br />
                            <asp:TextBox ID="txtRegisterPassword" TextMode="Password" runat="server" Width="350px"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:Label ID="lblRegisterConfirmPassword" runat="server" Text="Confirm Password :"></asp:Label>
                            <br />
                            <asp:TextBox ID="TextBox1" TextMode="Password" runat="server" Width="350px"></asp:TextBox>
